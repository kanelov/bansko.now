...
export function BusinessShell({
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[240px_minmax(0,1fr)]">
      <aside className="hidden print:!hidden border-r border-[var(--stone)] bg-white/60 px-5 py-6 lg:block">
      ...
      <div className="flex min-h-screen flex-col">
        <header className="sticky top-0 z-20 border-b print:hidden border-[var(--stone)] bg-paper/90 backdrop-blur">
