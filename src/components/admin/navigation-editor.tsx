...
const fieldClass = "w-full rounded-lg border border-white/10 bg-white px-3 py-2 text-sm text-stone-950";
...
function IconSelect({ name, value, options }: { name: string; value?: string | null; options: string[] }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-white/10 text-white">
  ...
  return (
    <div className="grid gap-4 rounded-2xl border border-white/10 bg-white/5 p-4">
      ...
      <div className="grid gap-3 lg:grid-cols-[1fr_1.35fr_0.9fr_0.45fr]">
        <label className="grid gap-1.5 text-xs font-semibold uppercase text-stone-400">
          Име на български
      ...
      <div className="flex flex-wrap items-center gap-3 text-sm text-stone-100">
        <label className="choice-row rounded-lg border border-white/10 bg-white/5 px-3 py-2">
        ...
        {item ? (
          <label className="choice-row rounded-lg border border-red-300/20 bg-red-500/10 px-3 py-2 text-red-100">
