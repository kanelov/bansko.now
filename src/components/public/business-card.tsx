  ...
  return (
    <article
      className={[
        ...
        wide ? "border-forest/25 lg:grid lg:grid-cols-[1.05fr_0.95fr]" : "border-stone-200"
      ].join(" ")}
    >
      <BusinessMedia business={business} className={`aspect-[4/3] overflow-hidden bg-sage ${wide ? "lg:h-full lg:min-h-72" : ""}`} />
