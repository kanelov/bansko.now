      ...
      <div className="rounded-2xl bg-white px-5 text-stone-950 shadow-soft sm:px-7">
        ...
        <GuideSection number="09" title="Български и английски версии">
          ...
          <ol className="mt-3 grid list-decimal gap-2 pl-5">
            ...
            <li>Постави английското заглавие, slug, excerpt, съдържание, SEO текстове и alt описания.</li>
            <li>Прегледай поотделно двете версии и публикувай всяка само когато е готова.</li>
            <li>Използвай езиковите бутони BG и EN в редактора, за да преминаваш между свързаните версии.</li>
          </ol>
          <p className="mt-4">
            Страниците работят по същия начин в „Страници“: отвори готовата версия и използвай бутона за добавяне на липсващия език. Категориите, менюто, общите настройки, Art Studio услугите и бизнесите имат отделни английски полета в съответните админ секции.
          </p>
