...
status: draft`}</CodeBlock>
        ...
        <GuideSection number="11" title="Онлайн галерия от киоска">
          ...
          <ul className="mt-3 grid list-disc gap-2 pl-5">
            <li>Продукти, варианти, наличност, снимки и категории се редактират в source приложението за заявки.</li>
            <li>BG/EN заглавията, slug, описанията, alt текстът, SEO полетата и WooCommerce линкът също се редактират там.</li>
          ...
          <p className="mt-4 rounded-xl bg-sage/40 p-4 text-forest">
            На продуктовата страница бутонът „Към категорията“ връща към точната категория, а „Предишен“ и „Следващ“ остават в същия категориен контекст.
          </p>
        </GuideSection>
      </div>
    </div>
