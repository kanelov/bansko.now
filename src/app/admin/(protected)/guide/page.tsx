...
status: draft`}</CodeBlock>
        ...
        <GuideSection number="11" title="Онлайн галерия от киоска">
          ...
          <p className="mt-4 rounded-xl bg-sage/40 p-4 text-forest">
            На продуктовата страница компактната навигация съдържа „Назад“, „Напред“, „Начало“ и „Най-харесвани“. Назад и напред остават в същия категориен контекст, а началото връща към основната галерия.
          </p>
        </GuideSection>
      </div>
    </div>
