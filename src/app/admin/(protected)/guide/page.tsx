...
status: draft`}</CodeBlock>
        ...
        <GuideSection number="11" title="Онлайн галерия от киоска">
          ...
          <p className="mt-4 rounded-xl bg-sage/40 p-4 text-forest">
            На продуктовата страница компактната навигация съдържа „Назад“, „Напред“, „Начало“ и „Най-харесвани“. Менюто „Най-харесвани“ използва същите подкатегории като киоска: „Тениски“, „Акварел“, „Пейзажна фотография“ и „Чаши“. Продукт се добавя само веднъж към съответната категория в source приложението и се показва и в киоска, и в Bansko NOW.
          </p>
        </GuideSection>
      </div>
    </div>
