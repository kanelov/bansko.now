      ...
      <section className={portalUi.card}>
        ...
        <GuideSection number="5" title="Екрани: телевизорите в заведението">
          <GuideSummary>
            ...
            <p>„Преглед“ на страницата на екрана е точно това, което е на телевизора. Ако пише „не се събира“ – махни категория или изключи описанията.</p>
          </GuideSummary>
          <p>
        ...
        <GuideSection number="6" title="Какво предстои">
          <GuideSummary>
            <p>Меню за печат (А4, А3, за маса) идва следващо. И то ползва същото меню - няма да се въвежда втори път.</p>
          </GuideSummary>
        </GuideSection>
      </section>
