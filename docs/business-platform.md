...
> | 7 · Втвърдяване и помощ в портала | в ход | 2026-09-17 | готово: помощ в портала, управление от админа (`/admin/platform`: статус, модули, собственици с временна парола, видеа), смяна на парола в портала, скрипт за базата без конектор; остава: изключване на публичната регистрация, ограничаване на опитите за вход, защита от изтекли пароли |
